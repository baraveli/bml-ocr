...
class BmlOcrTest extends TestCase
{
    ...
    public function it_returns_a_valid_detected_text_in_invoice()
    {
        ...
        $this->assertEquals('Transfer transaction is successful.', $result->message);
        $this->assertEquals('BLAZ975518153732', $result->reference);
        ...
        $this->assertEquals('server', $result->remarks);
    }
}
